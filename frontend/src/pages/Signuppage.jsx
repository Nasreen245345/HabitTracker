  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="bg-customWhite w-full sm:w-3/4 md:w-1/2 lg:w-1/3 xl:w-1/4 mx-auto flex flex-col justify-center rounded-lg gap-4 py-6 px-6 shadow-lg">
        ...
        <div className="text-center text-lg text-black">Welcome to Habit Tracker</div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 flex flex-col">
          ...
          <button type="submit" className="bg-blue1 text-white py-2 rounded-md font-inter text-lg font-bold">Sign Up</button>
        </form>

        <div className="text-center font-inter text-lg">
          Already have an account?{" "}
          <button onClick={() => navigate("/login")} className="text-blue1 font-inter text-lg font-bold hover:underline">
            Login
          </button>
        </div>
      </div>
